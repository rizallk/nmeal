...
<div class="tambah-bahan-makanan">
  ...
  <form id="form-register" action="<?= site_url('tambah-bahan-makanan/register') ?>" method="post">
    <?= csrf_field() ?>
    <div class="row">
      <div class="mb-3">
        <label for="name" class="form-label">Nama Bahan Makanan<span class="text-danger">*</span></label>
        <input type="text" name="name" class="form-control <?= $errors && isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" placeholder="Nama Bahan Makanan" value="<?= old('name') ?>" required>
