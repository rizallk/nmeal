...
<div class="edit-allergen">
  ...
  <form id="form-register" action="<?= site_url('update-allergen/' . $alergen['id']) ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="name" class="form-control <?= $errors && isset($errors['name']) ? 'is-invalid' : '' ?>" id="name" placeholder="Nama Allergen" value="<?= old('name', $allergen['name']) ?>" required>
